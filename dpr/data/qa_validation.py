...
QAMatchStats = collections.namedtuple("QAMatchStats", ["top_k_hits", "questions_doc_hits", "mrr"])
...
def calculate_matches(
    ...
    for question_hits in scores:
        ...
        if best_hit is not None:
            ...
            reciprocal_ranks.append(1 / (best_hit + 1))
    
    mrr = sum(reciprocal_ranks) / len(reciprocal_ranks) if reciprocal_ranks else 0

    return QAMatchStats(top_k_hits, scores, mrr)
